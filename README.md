...
- [dashboard-bugfix-playbook](https://github.com/oimrqs-ops/dashboard-bugfix-playbook) - dependency-free dashboard audit with before/after fixtures, responsive checks, table/chart handoff notes, and Node tests.
